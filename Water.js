document.addEventListener('DOMContentLoaded', () => {
    class WaterNotificationSystem {
        constructor(cardId, config = {}) {
            ...
            this.waterCard = document.getElementById(cardId);
        ...
        initialize() {
            this.waterCard.style.cursor = 'pointer';
            this.waterCard.addEventListener('mouseenter', () => {
                this.addNotification();
                this.notificationInterval = setInterval(() => this.addNotification(), this.config.notificationInterval);
            });
            this.waterCard.addEventListener('mouseleave', () => {
    ...
    new WaterNotificationSystem('water-card');
});
